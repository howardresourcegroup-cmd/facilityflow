...
const TYPE_CONFIG = {
  ...
  comment_added:       { icon: MessageSquare,color: "text-zinc-400",    bg: "bg-white/[0.06]" },
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center gap-2 mt-1">
          ...
          <span className="text-xs text-zinc-600">{item.user.name}</span>
  ...
  return (
    <div className="glass-card p-5 h-full flex flex-col">
      <div className="flex items-center justify-between mb-2">
        <div>
          <p className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Live Activity</p>
          <p className="text-base font-semibold text-zinc-200 mt-0.5">Recent Events</p>
        </div>
