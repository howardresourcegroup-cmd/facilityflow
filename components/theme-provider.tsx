...
export const ACCENTS: Record<AccentKey, { label: string; ramp: Record<300 | 400 | 500 | 600, string>; swatch: string }> = {
  indigo:  { label: "Indigo",  swatch: "#6366f1", ramp: { 300: "165 180 252", 400: "129 140 248", 500: "99 102 241", 600: "79 70 229" } },
  emerald: { label: "Emerald", swatch: "#10b981", ramp: { 300: "110 231 183", 400: "52 211 153", 500: "16 185 129", 600: "5 150 105" } },
  blue:    { label: "Blue",    swatch: "#3b82f6", ramp: { 300: "147 197 253", 400: "96 165 250", 500: "59 130 246", 600: "37 99 235" } },
  violet:  { label: "Violet",  swatch: "#8b5cf6", ramp: { 300: "196 181 253", 400: "167 139 250", 500: "139 92 246", 600: "124 58 237" } },
  rose:    { label: "Rose",    swatch: "#f43f5e", ramp: { 300: "253 164 175", 400: "251 113 133", 500: "244 63 94", 600: "225 29 72" } },
  amber:   { label: "Amber",   swatch: "#f59e0b", ramp: { 300: "252 211 77", 400: "251 191 36", 500: "245 158 11", 600: "217 119 6" } },
};
...
function applyAccent(accent: AccentKey) {
  const ramp = ACCENTS[accent].ramp;
  const el = document.documentElement;
